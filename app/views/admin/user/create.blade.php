...
<main>
    ...
    <div class="table-data">
        <div class="order">
            ...
            <form action="{{ route('admin/user/create')}}" class="form-input" method="post" enctype="multipart/form-data">
                <div class=" row form-group pb-4">
                    ...
                    <div class="col-6"><label for="" class="label pt-2">
                        ...
                        <input type="file" name="image" id="" value="" class="input w-75 rounded-2"><br />
                        ...
                        <input type="number" name="phonenumber" id="" value="" placeholder="Nhập số điện thoại"
                            class="input w-75 rounded-2"><br />
